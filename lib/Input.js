  ...
  _createClass(Input, [{
    ...
    value: function getLocals(props) {
      var value = props.value,
          ...
          inputProps = _objectWithoutProperties(props, ['value', 'iconClearClassName', 'iconClassName', 'hasValue', 'active', 'small', 'onButtonClick', 'onInputClick', 'onInputChange', 'onInputClear', 'onInputKeyUp', 'displayFormat']);

      var datePatternRegex = /[mMyYdD]/;
      var datePatternObject = [];
      var delimiter = void 0;
      displayFormat.split('').forEach(function (char) {
      ...
      var datePattern = [].concat(_toConsumableArray(new Set(datePatternObject)));
    ...
    value: function template(_ref3) {
      var className = _ref3.className,
          ...
          datePattern = _ref3.datePattern;

      return _react2.default.createElement(
        'div',
        { className: className },
        _react2.default.createElement(_react4.default, _extends({
          options: {
            date: true,
            delimiter: delimiter,
            datePattern: datePattern
