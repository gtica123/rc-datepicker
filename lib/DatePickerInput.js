...
var Props = exports.Props = {
  ...
  onBlur: _tcomb2.default.maybe(_tcomb2.default.Function),
  ...
  cleaveOptions: _tcomb2.default.maybe(_tcomb2.default.Object),
...
var DatePickerInput = (_dec = (0, _utils.skinnable)(), _dec2 = (0, _tcombReact.props)(Props, { strict: false }), (0, _utils.format)(_class = (0, _utils.valueLink)(_class = _dec(_class = _dec2(_class = (_temp = _class2 = function (_React$Component) {
  ...
  _createClass(DatePickerInput, [{
    ...
    value: function getLocals(props) {
      ...
      var inputProps = (0, _lodash2.default)(props, Object.keys(Props));
  ...
  this.onChangeInput = function (event) {
    ...
    _this3.setState({
      ...
      return _this3.getValueLink().requestChange(jsDate, returnedDateString, event);
    });
  };
